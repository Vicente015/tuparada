...
const MAX_BOUNDS: LngLatBoundsLike = [
  -15.882797, 27.723931, -15.315628, 28.195578,
];
...
function removeAllPOIs(baseLayers: maplibregl.LayerSpecification[]) {
  return baseLayers.filter(
    (layer) => !layer.id?.includes("poi") && !layer.id?.includes("pois"),
  );
}
...
export default function Map() {
  ...
  console.debug("Cords: " + geolocation.latitude + geolocation.longitude);
